...
export async function sendMemberInvitationEmail(email, invitationId) {
  ...
  throw lastNetworkError || new Error(`IRPA mail gateway could not be reached at ${gateways.join(" or ")}. Please verify the deployed IRPA mail gateway is online.`);
}

 ...
 return <div className="page dashboard-command">
   <div className="dashboard-desktop-view">
    <section className="desktop-quote4-hero">
      ...
      <div className="desktop-date-card open-portal-panel" aria-label="Live date and time"><span>LIVE DATE & TIME</span><strong>{liveDay}</strong><small>{liveDate} · {liveTime}</small><em className="desktop-date-workspace">IRPA Digital Governance Workspace</em></div>
    </section>

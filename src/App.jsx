 ...
 return <div className="page dashboard-command">
   ...
   <div className="dashboard-mobile-view" aria-label="Mobile IRPA governance dashboard">
    <section className="mobile-quote1-hero">
      ...
      <div className="mobile-quote1-top"><img src="/irpa-logo.svg" alt="IRPA"/><div><strong>IMPROVEMENT OF RANGELAND</strong><small>IN PASTORAL AREAS</small></div><button type="button" onClick={()=>go("Alerts")} aria-label="Notifications">●</button></div>

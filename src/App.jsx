    ...
    try{
      ...
      if(redirectedUser&&!disposed){
        ...
        if(actual==="irpa2412@gmail.com"){
          ...
          if(new URLSearchParams(window.location.search).get("")==="1"){

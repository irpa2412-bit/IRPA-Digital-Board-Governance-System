 ...
 return <div className="page dashboard-command">
   <div className="dashboard-desktop-view">
    <section className="desktop-quote4-hero">
      ...
      <div className="desktop-date-card open-portal-panel" aria-live="polite" aria-label="Open portal"><span>OPEN PORTAL</span><strong>Dashboard</strong><small>IRPA Digital Governance Workspace</small></div>
    </section>

    ...
    <aside className="sidebar">
      <div className="sidebar-brand">
        <div className="sidebar-brand-logo-wrap" aria-label="IRPA logo">
          <img className="sidebar-brand-logo" src="/irpa-logo-pitch.svg" alt="IRPA" />
        </div>

...
const OPERATIONAL_ROLE_PERMISSIONS = Object.freeze({
  "Director Internal Oversight": ["authorization.permission.view","authorization.permission.grant","authorization.permission.revoke","authorization.workflow.review","authorization.workflow.return","resolution.view","reports.view"],
  "Internal Oversight Officer": ["authorization.permission.view","authorization.workflow.review","authorization.workflow.return","resolution.view","reports.view"],
  "Director Human Resources": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","member.create","member.update","member.remove","reports.view"],
  "HR Manager": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","member.create","member.update","reports.view"],
  "Director Finance & Administration": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","finance.view","finance.create","finance.approve","reports.view","document.view"],
  "Finance Manager": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","finance.view","finance.create","reports.view","document.view"],
  "Programme/Technical Officer": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","meeting.create","meeting.edit","meeting.view","document.create","document.edit","document.view","reports.create","reports.view"],
  "Operations Manager": ["authorization.workflow.review","authorization.workflow.return","authorization.workflow.complete","meeting.create","meeting.edit","meeting.view","document.view","reports.create","reports.view"],
  "Executive Director": ["authorization.permission.view","authorization.workflow.approve","authorization.workflow.reject","authorization.workflow.complete","meeting.view","resolution.view","resolution.approve","document.view","document.sign","signature.sign","finance.view","finance.approve","reports.view","reports.create"],
